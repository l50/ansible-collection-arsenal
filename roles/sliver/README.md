...
| `sliver_packages.essential.6` | str | `libxml2-dev` | No description |
...
| `sliver_packages.build_only.14` | str | `libreadline-dev` | No description |
| `sliver_packages.build_only.15` | str | `libsqlite3-dev` | No description |
| `sliver_packages.build_only.16` | str | `libgdbm-dev` | No description |
| `sliver_packages.build_only.17` | str | `libdb5.3-dev` | No description |
| `sliver_packages.build_only.18` | str | `libbz2-dev` | No description |
| `sliver_packages.build_only.19` | str | `libexpat1-dev` | No description |
| `sliver_packages.build_only.20` | str | `liblzma-dev` | No description |
| `sliver_packages.build_only.21` | str | `libffi-dev` | No description |
...
| `sliver_packages.runtime_debian.5` | str | `zlib1g` | No description |
| `sliver_packages.runtime_debian.6` | str | `xsel` | No description |
| `sliver_packages.runtime_debian.7` | str | `libcurl4-openssl-dev` | No description |
| `sliver_packages.runtime_debian.8` | str | `libgmp3-dev` | No description |
| `sliver_packages.runtime_debian.9` | str | `libpcap-dev` | No description |
| `sliver_packages.runtime_debian.10` | str | `libpq-dev` | No description |
| `sliver_packages.runtime_debian.11` | str | `libxml2-dev` | No description |
| `sliver_packages.runtime_debian.12` | str | `libxslt-dev` | No description |
| `sliver_packages.runtime_debian.13` | str | `libyaml-dev` | No description |
| `sliver_packages.runtime_debian.14` | str | `postgresql` | No description |
| `sliver_packages.runtime_debian.15` | str | `postgresql-contrib` | No description |
| `sliver_packages.runtime_debian.16` | str | `postgresql-client` | No description |
