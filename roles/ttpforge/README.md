...
| `ttpforge_username` | str | <code>{{ ansible_facts&#91;'user_id'&#93; if ansible_facts&#91;'os_family'&#93; == 'Darwin' else ansible_facts&#91;'distribution'&#93; &#124; lower }}</code> | No description |
| `ttpforge_usergroup` | str | <code>{{ 'staff' if ansible_facts&#91;'os_family'&#93; == 'Darwin' else ansible_facts&#91;'user_id'&#93; if ansible_facts&#91;'os_family'&#93; in &#91;'Debian', 'RedHat'&#93; else ansible_facts&#91;'distribution'&#93; &#124; lower }}</code> | No description |
| `ttpforge_shell` | str | <code>{{ '/bin/zsh' if ansible_facts&#91;'os_family'&#93; == 'Darwin' else '/bin/bash' }}</code> | No description |
...
- **Trust mise config in ttpforge directory** (ansible.builtin.command) - Conditional
